 ...
 */
 public class User implements Serializable
 {
     ...
     //Has methods that need to be implemented in Photo Class
    ...
    //   * */
    //  public List<Photo> getPhotosByDateRange(LocalDate fromDate, LocalDate toDate)
    //  {
    ...
    //          {
    //              LocalDate photoDate = photo.getDate().toInstant().atZone(ZoneId.systemDefault()).toLocalDate();
    //              if (photoDate.isAfter(fromDate) && photoDate.isBefore(toDate) || photoDate.equals(fromDate) || photoDate.equals(toDate))
    ...
    //  public List<Photo> getPhotosByDisjunctiveTags(List<Tag> tagList)
    //  {
    //     HashSet<Photo> photosSet = new HashSet<>();
    ...
    //             for(Tag t: tagList)
    //             {
    //                 if(p.tagExists(t.getTagName(), t.getTagValue()))
    //                 {
    //                     photosSet.add(p);
    //                     break;
    //                 }
    ...
    //         }
    //     }
    //     return new ArrayList<>(photosSet);
    //  }

    //  public List<Photo> getPhotosByConjunctiveTags(List<Tag> tagList)
    //  {
    //     HashSet<Photo> photosSet = new HashSet<>();

    //     for(Album a : userAlbums)
    //     {
    //         for(Photo p : userAlbums.getPhotos())
    //         {
    //             if(p.getTagList().contains(tagList))
    //                 photosSet.add(p);
    //         }
    //     }
